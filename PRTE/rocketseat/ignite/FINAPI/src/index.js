...
//Middleware para validar existencia de usuario "logado"
...
//funcao pra somar o total da conta
...
app.post("/account", (request, response) => {
    ...
    const customerAlreadyExists = customers.some(
        ...
        );//constante para validar cpf repetido
...
app.delete('/account', verifyIfExistAccountCPF, (request, response) => {
    ...
    customers = customers.filter(
        (customer1) => customer1.cpf !== customer.cpf
    )
